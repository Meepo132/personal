  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-gray-800 dark:text-gray-300 selection:bg-blue-500/30 font-sans transition-colors duration-300">
      ...
      <main className="max-w-6xl mx-auto px-6 py-24">
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="flex-1 space-y-6">
              ...
              <div className="space-y-4 text-[17px] leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                <p>
                  Coming from a background in <span className="text-blue-400 font-medium">Cybersecurity and Networking</span>,
              ...
              <div className="grid grid-cols-2 gap-4 pt-6">
                <div className="p-5 rounded-2xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5 hover:border-blue-500/30 transition-all group">
                  ...
                  <h4 className="font-bold text-sm dark:text-white">Clean & Scalable</h4>
                ...
                <div className="p-5 rounded-2xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5 hover:border-cyan-500/30 transition-all group">
                  ...
                  <h4 className="font-bold text-sm dark:text-white">User-Focused</h4>
        ...
        {/* --- Education Section (Balanced & Hover Fixed) --- */}
        <section id="education" className="mb-40 scroll-mt-28">
          <div className="flex items-center gap-3 mb-12">
            <div className="w-10 h-10 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-500">
              <GraduationCap size={22} />
            </div>
            <h3 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Education</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-8 rounded-[2.5rem] border border-gray-100 dark:border-white/10 bg-white dark:bg-[#0a0a0a] shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-500 group flex flex-col justify-center cursor-default">
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1 text-sm font-medium">Myanmar Tech Academy</p>
            </div>
